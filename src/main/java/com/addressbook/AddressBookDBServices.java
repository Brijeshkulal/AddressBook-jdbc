...
public class AddressBookDBServices {
	private static AddressBookDBServices addressBookDBService;
	private PreparedStatement contactDataStatement;

	public static AddressBookDBServices getInstance() {
		if (addressBookDBService == null)
			addressBookDBService = new AddressBookDBServices();
